...
{
    private const string GithubReleasesUrl = "https://api.github.com/repos/OpenShock/LocalRelay/releases";
    ...
    public Updater(ILogger<Updater> logger, ConfigManager configManager)
    {
        ...
        HttpClient.DefaultRequestHeaders.Add("User-Agent", $"LocalRelay/{CurrentVersion}");
    }
